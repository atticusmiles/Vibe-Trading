...
export function Stocks() {
  ...
  return (
    <div className="flex h-full flex-col gap-4 p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-1">
            <button onClick={() => setTab("entities")} className={cn("rounded-md px-3 py-1 text-xs font-medium transition-colors", tab === "entities" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted")}>自选股</button>
      ...
      {tab === "candidates" ? (
        <CandidatesTab targetType="stock" />
      ) : (
